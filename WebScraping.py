# Taken from https://towardsdatascience.com/scraping-1000s-of-news-articles-using-10-simple-steps-d57636a49755

# An alternative method for web scraping can be found at : https://github.com/miguelfzafra/Latest-News-Classifier
...
f.close()
data = pd.DataFrame(upperframe, columns=[
